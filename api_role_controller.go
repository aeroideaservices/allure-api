...
/*
RoleControllerApiService Create a new role
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body

@return RoleDto
*/
func (a *RoleControllerApiService) Create22(ctx context.Context, body RoleCreateDto) (RoleDto, *http.Response, error) {
	var (
...
/*
RoleControllerApiService Delete role by id
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id
*/
func (a *RoleControllerApiService) Delete20(ctx context.Context, id int64) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/role/{id}"
...
/*
RoleControllerApiService Find all roles
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []RoleDto
*/
func (a *RoleControllerApiService) FindAll19(ctx context.Context) ([]RoleDto, *http.Response, error) {
	var (
...
/*
RoleControllerApiService Find role by id
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id

@return RoleDto
*/
func (a *RoleControllerApiService) FindOne17(ctx context.Context, id int64) (RoleDto, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
RoleControllerApiService Patch a role
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param id
...
@return RoleDto
*/
func (a *RoleControllerApiService) Patch19(ctx context.Context, body RolePatchDto, id int64) (RoleDto, *http.Response, error) {
	var (
...
/*
RoleControllerApiService Suggest roles
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RoleControllerApiSuggest8Opts - Optional Parameters:
...
type RoleControllerApiSuggest8Opts struct {
...
func (a *RoleControllerApiService) Suggest8(ctx context.Context, localVarOptionals *RoleControllerApiSuggest8Opts) (PageIdAndNameOnlyDto, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/role/suggest"
