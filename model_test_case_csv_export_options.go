...
type TestCaseCsvExportOptions struct {
	Name            string                                      `json:"name,omitempty"`
	WithHeaders     bool                                        `json:"withHeaders,omitempty"`
	ColumnSeparator string                                      `json:"columnSeparator,omitempty"`
	Selection       *TestCaseTreeSelectionDto                   `json:"selection,omitempty"`
	Mapping         []OneOfTestCaseCsvExportOptionsMappingItems `json:"mapping,omitempty"`
}
