...
type TestResultCsvExportOptions struct {
	Name            string                                        `json:"name,omitempty"`
	WithHeaders     bool                                          `json:"withHeaders,omitempty"`
	ColumnSeparator string                                        `json:"columnSeparator,omitempty"`
	Selection       *TestResultTreeSelectionDto                   `json:"selection,omitempty"`
	Mapping         []OneOfTestResultCsvExportOptionsMappingItems `json:"mapping,omitempty"`
}
